...
![Build](https://github.com/NHSDigital/covid-medical-exemptions/workflows/Build/badge.svg?branch=master)
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/covid-medical-exemptions/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/covid-medical-exemptions/blob/master/CODE_OF_CONDUCT.md).
...
Successful deployment of the API Proxy requires:
 ...
 1. A *Target Server* named `covid-medical-exemptions-target`
 2. A *Key-Value Map* named `cme-variables`, containing any values you might need at proxy runtime
 3. A *Key-Value Map* named `cme-variables-encrypted`, containing any secrets you might need at proxy runtime
